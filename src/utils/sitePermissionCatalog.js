...
export const SITE_PERMISSION_ROUTES = [
  page('/site-admin/index', '首页', 'backends/siteAdmin/dashboard/index'),
  ...
  menu('/site-admin/agent', '代理管理', [
    ...
    page('comm/index', '佣金方案', 'backends/siteAdmin/agent/comm/index'),
    page('record', '佣金账单', 'backends/siteAdmin/agent/record'),
    page('grant', '佣金发放', 'backends/siteAdmin/agent/grant'),
    ...
    page('advanceRecords', '代理预支记录', 'agent/advanceRecords/index')
  ]),
  menu('/site-admin/funds', '财务管理', [
    ...
    page('redPacket', '会员红包', 'backends/siteAdmin/funds/redPacket/index')
  ]),
  menu('/site-admin/game', '游戏管理', [
    page('index', '游戏列表', 'backends/siteAdmin/game/index'),
    page('record', '游戏记录', 'backends/siteAdmin/game/record/index'),
    page('gameBet', '游戏下注', 'backends/siteAdmin/game/record/gameBet'),
  ...
  menu('/site-admin/site', '站点管理', [
    ...
    page('config/index', '站点配置', 'backends/siteAdmin/site/config/index'),
    ...
    page('venueManage', '场馆配置', 'backends/siteAdmin/site/venue/VenueManage'),
    page('gameManage', '游戏配置', 'backends/siteAdmin/site/venue/GameManage')
  ]),
  menu('/site-admin/resources', '资源管理', [
    page('skin', '皮肤管理', 'backends/siteAdmin/resources/skin/index')
  ]),
  menu('/site-admin/venue', '场馆管理', [
  ...
  menu('/site-admin/monitor', '系统监控', [
    ...
    page('logininfor', '登录日志', 'backends/siteAdmin/monitor/logininfor/index'),
    page('operlog', '操作日志', 'backends/siteAdmin/monitor/operlog/index'),
